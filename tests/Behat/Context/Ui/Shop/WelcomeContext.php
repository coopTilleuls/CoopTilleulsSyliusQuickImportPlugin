...
namespace Tests\CoopTilleuls\SyliusQuickImportPlugin\Behat\Context\Ui\Shop;

use Behat\Behat\Context\Context;
use Tests\CoopTilleuls\SyliusQuickImportPlugin\Behat\Page\Shop\WelcomePageInterface;
